...
namespace Kevin.Infrastructure.Domain.Specification
{
    /// <summary>
        ...
        where TEntity : class
    {
        ...
        /// <summary>
        /// <see cref="Kevin.Infrastructure.Domain.Specification.ISpecification{TEntity}"/>
        /// </summary>
        /// <returns><see cref="Kevin.Infrastructure.Domain.Specification.ISpecification{TEntity}"/></returns>
