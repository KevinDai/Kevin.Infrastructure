...
namespace Kevin.Infrastructure.Domain.Specification
{
         ...
         where T : class
    {
        ...
        /// <summary>
        /// <see cref="Kevin.Infrastructure.Domain.Specification.ISpecification{T}"/>
        /// </summary>
        /// <returns><see cref="Kevin.Infrastructure.Domain.Specification.ISpecification{T}"/></returns>
