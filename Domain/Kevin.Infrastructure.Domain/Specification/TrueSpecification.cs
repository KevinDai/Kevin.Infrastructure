...
namespace Kevin.Infrastructure.Domain.Specification
{
        ...
        where TEntity:class
    {
        ...
        /// <summary>
        /// <see cref=" Kevin.Infrastructure.Domain.Specification.Specification{TEntity}"/>
        /// </summary>
        /// <returns><see cref=" Kevin.Infrastructure.Domain.Specification.Specification{TEntity}"/></returns>
